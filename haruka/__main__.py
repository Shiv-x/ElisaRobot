...
def send_start(bot, update):
    ...
    keyboard += [[InlineKeyboardButton(text="🛠 Reporting", callback_data="cntrl_panel_M"), InlineKeyboardButton(text="❓ Help", callback_data="help_back")], 
                 [InlineKeyboardButton(text="👥 Add Elisa to your group", url="https://t.me/ElisaRobot?startgroup=new")]]
